package com.cms.szy.configuration.datasource.jpa;
...
import com.cms.szy.configuration.jpa.BaseSimpleJpaRepositoryEx;
...
public class MasterRepositoryConfig {
    ...
    public LocalContainerEntityManagerFactoryBean masterEntityManagerFactory(EntityManagerFactoryBuilder builder) {
        return builder
                ...
                .packages("com.cms.szy.entity.po")//设置实体类所在位置
