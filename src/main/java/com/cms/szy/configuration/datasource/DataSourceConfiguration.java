package com.cms.szy.configuration.datasource;
...
import com.cms.szy.configuration.properties.DataSourceConfig;
...
//	@ConfigurationProperties(prefix = "master.spring.datasource")
	...
	public DataSource masterDataSource() throws Exception {
		GwsLogger.info("jason_cms 数据源初始化中...");
		System.out.println("jason_cms datasource init ...");
		...
		GwsLogger.info("jason_cms 数据源初始化成功。");
		System.out.println("jason_cms datasource init success...");
